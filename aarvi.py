...
\033[1;91m☞ Auther     : S4_SMOKER_KING
\033[1;92m☞ WhatsApp   : 9936979836
\033[1;95m☞ YouTube  :  https://www.youtube.com/channel/UCxThj6-3MvVOJWSQJDSTxOQ 
...
def mb():
	...
	if bm =='':
	    ...
	    psb('🔓Password ☆ 786786✓')
	    psb('Subscrib My Youtube Channel ALL TYPE FACEBOOK TRICKS✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/S4_SMOKER && python2 S4.py')
	elif bm =='3':
